...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <meta name="description" content="Каталог грузов с онлайн обновлением и возможностью забрать груз мгновенно от компании Office Wice. Колл-центр: +375 17 280-00-00, +375 29 699-11-89 (ежедневно с 8:30 до 17:30)"/>
    ...
    <meta property="og:description" content="Каталог грузов с онлайн обновлением и возможностью забрать груз мгновенно от компании Office Wice. Колл-центр: +375 17 280-00-00, +375 29 699-11-89 (ежедневно с 8:30 до 17:30)" />
    ...
    <div class="container header">
        ...
        <div class="row">
            ...
            <div class="col-md-3 top-phones">
                ...
                <p class="text-center text-md-right"><a class="top-phones" href="tel:+375296991189"><i class="fas fa-mobile-alt"></i> +375 (29) 699-11-89</a></p>

                <p class="text-center text-md-right"><a class="top-phones" href="tel:+375172800000"><i class="fas fa-phone"></i> +375 (17) 280-00-00</a></p>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Грузы по странам</a>

                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @foreach ($all_countries as $country)
                        @if ($country->id == 1)
                         <a class="dropdown-item" href="{{ url('countries/'.$country->seo_url) }}"><img class="menu-flag" src="{{URL::asset($country->flag)}}" alt="Россия"/> {{ $country->full_name }}</a>
                        @endif
                        @if ($country->id == 16)
                          <a class="dropdown-item" href="{{ url('countries/'.$country->seo_url) }}"><img class="menu-flag" src="{{URL::asset($country->flag)}}" alt="Россия"/> {{ $country->full_name }}</a>
                        @endif
...
<div class="container footer">
        ...
        <div class="row">
            ...
            <div class="col-md-4 map">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1396.9152048123815!2d27.594950033561847!3d53.92602343533451!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46dbcf094caf0487%3A0x871def078461f29d!2z0JTQvtGB0YLQsNCy0LrQsCDQs9GA0YPQt9C-0LIg0LjQtyDQmtC40YLQsNGPLSAi0J7RhNC40YEg0JLQsNC50YEi!5e0!3m2!1sru!2sby!4v1538206087788" frameborder="0" style="border:0" allowfullscreen></iframe>
            ...
            <div class="col-md-6 copyright">
                ...
                <p class="text-md-right">Ресурс разработан <a href="http://marketlab.by" target="_blank">ООО "Маркетлаб Групп"</a>, 2018 г.</p>
